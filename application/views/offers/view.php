...
<div class="modal-footer">
    ...
    if ($model_info->created_by == $this->login_user->id || $this->login_user->is_admin) {
        echo modal_anchor(get_uri("offers/modal_form/"), "<i class='fa fa-pencil'></i> " . lang('edit_offers'), array("class" => "btn btn-default", "data-post-id" => $model_info->id, "title" => lang('edit_offers')));
    }
    ?>
