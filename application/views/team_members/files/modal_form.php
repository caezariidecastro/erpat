<?php echo form_open(get_uri("hrs/team_members/save_file"), array("id" => "file-form", "class" => "general-form", "role" => "form")); ?>
<div class="modal-body clearfix">
    <input type="hidden" name="user_id" value="<?php echo $user_id; ?>" />
    <?php
    $this->load->view("includes/multi_file_uploader", array(
        "upload_url" =>get_uri("hrs/team_members/upload_file"),
        "validation_url" =>get_uri("hrs/team_members/validate_file"),
    ));
    ?>
</div>
