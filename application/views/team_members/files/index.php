<div class="panel">
    <div class="tab-title clearfix">
        ...
        <div class="title-button-group">
            <?php
            echo modal_anchor(get_uri("hrs/team_members/file_modal_form"), "<i class='fa fa-plus-circle'></i> " . lang('add_files'), array("class" => "btn btn-default", "title" => lang('add_files'), "data-post-user_id" => $user_id));
            ?>
        </div>
    </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#team-member-file-table").appTable({
            source: '<?php echo_uri("hrs/team_members/files_list_data/" . $user_id) ?>',
            order: [[0, "desc"]],
            columns: [
