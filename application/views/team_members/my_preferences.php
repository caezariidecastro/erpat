<div class="tab-content">
    ...
    echo form_open(get_uri("hrs/team_members/save_my_preferences/"), array("id" => "my-preferences-form", "class" => "general-form dashed-row white", "role" => "form"));
    ?>
    <div class="panel">
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                ...
                <div class=" col-md-3">
                    ...
                    echo modal_anchor(get_uri("hrs/team_members/keyboard_shortcut_modal_form/"), "<i class='fa fa-info'></i>", array("class" => "btn btn-default keyboard-shortcut-info-icon ml10", "title" => lang('keyboard_shortcuts_info'), "data-post-user_id" => $this->login_user->id));
                    ?>
                </div>
            </div>
