...
?>">
    <ul id="team-member-attendance-tabs" data-toggle="ajax-tab" class="nav nav-tabs bg-white title" role="tablist">
        ...
        <li><a role="presentation" href="<?php echo_uri("hrs/team_members/weekly_attendance/"); ?>" data-target="#team_member-weekly-attendance"><?php echo lang('weekly'); ?></a></li>    
        <li><a role="presentation" href="<?php echo_uri("hrs/team_members/custom_range_attendance/"); ?>" data-target="#team_member-custom-range-attendance"><?php echo lang('custom'); ?></a></li>    
        <li><a role="presentation" href="<?php echo_uri("hrs/team_members/attendance_summary/" . $user_id); ?>" data-target="#team_member-attendance-summary"><?php echo lang('summary'); ?></a></li>   
