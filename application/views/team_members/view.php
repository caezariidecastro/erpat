...
<div id="page-content" class="clearfix">
    ...
    <ul id="team-member-view-tabs" data-toggle="ajax-tab" class="nav nav-tabs" role="tablist">
        ...
        <?php if ($show_general_info) { ?>
            <li><a  role="presentation" href="<?php echo_uri("hrs/team_members/general_info/" . $user_info->id); ?>" data-target="#tab-general-info"> <?php echo lang('general_info'); ?></a></li>
        <?php } ?>
        ...
        <?php if ($show_account_settings) { ?>
            <li><a role="presentation" href="<?php echo_uri("hrs/team_members/account_settings/" . $user_info->id); ?>" data-target="#tab-account-settings"> <?php echo lang('account_settings'); ?></a></li>
        <?php } ?>
        ...
        <?php if ($show_expense_info) { ?>
            <li><a role="presentation" href="<?php echo_uri("hrs/team_members/expense_info/" . $user_info->id); ?>" data-target="#tab-expense-info"><?php echo lang('expenses'); ?></a></li>
        <?php } ?>
