<div id="page-content" class="p20 clearfix">
    <div class="panel panel-default">
        <div class="table-responsive">
            <table id="contribution_view_data-table" class="display" cellspacing="0" width="100%">            
            </table>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#contribution_view_data-table").appTable({
            source: '<?php echo_uri("hrs/team_members/contribution_view_data") ?>',
            order: [[1, "asc"]],
            filterDropdown: [
            ...
            columns: [
                ...
                {title: "<?php echo lang("sss") ?>", "class": "w10p"},
                {title: "<?php echo lang("tin") ?>", "class": "w10p"},
                {title: "<?php echo lang("pag_ibig") ?>", "class": "w10p"},
                {title: "<?php echo lang("phil_health") ?>", "class": "w10p"},
            ],
