    ...
    <div class="page-title clearfix mb20">
        ...
        <div class="title-button-group">
            ...
            if ($this->login_user->is_admin) {
                ...
                echo modal_anchor(get_uri("hrs/team_members/modal_form"), "<i class='fa fa-plus-circle'></i> " . lang('add_employee'), array("class" => "btn btn-default", "title" => lang('add_employee')));
            }
            ?>
        </div>
    </div>
