<div id="page-content" class="p20 clearfix">
    <div class="panel panel-default">
        <div class="table-responsive">
            <table id="personal_view_data-table" class="display" cellspacing="0" width="100%">            
            </table>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#personal_view_data-table").appTable({
            source: '<?php echo_uri("hrs/team_members/personal_view_data") ?>',
            order: [[1, "asc"]],
            filterDropdown: [
            ...
            columns: [
                ...
                {title: "<?php echo lang("gender") ?>", "class": "w10p"},
                {title: "<?php echo lang("date_of_birth") ?>", "class": "w10p"},
                {title: "<?php echo lang("street") ?>", "class": "w20p"},
                {title: "<?php echo lang("city") ?>", "class": "w10p"},
                {title: "<?php echo lang("state") ?>", "class": "w10p"},
                {title: "<?php echo lang("country") ?>", "class": "w10p"},
                {title: "<?php echo lang("zip_code") ?>", "class": "w10p"},
                {title: "<?php echo lang("alt_Addresss") ?>"}
            ],
