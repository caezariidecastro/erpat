<div id="page-content" class="p20 clearfix">
    <div class="panel panel-default">
        <ul id="leaves-tabs" data-toggle="ajax-tab" class="nav nav-tabs bg-white inner" role="tablist">
            ...
            <li><a  role="presentation" class="active" href="<?php echo_uri("css/tickets/view_browse"); ?>" data-target="#browse-panel"><?php echo lang("browse"); ?></a></li>
            <li><a  role="presentation" href="<?php echo_uri("css/tickets/view_templates"); ?>" data-target="#templates-panel"><?php echo lang("templates"); ?></a></li>
            <li><a  role="presentation" href="<?php echo_uri("css/tickets/view_types"); ?>" data-target="#types-panel"><?php echo lang("types"); ?></a></li>
        </ul>
