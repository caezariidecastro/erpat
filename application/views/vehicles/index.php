    ...
    <div class="panel panel-default">
        <div class="page-title clearfix">
            ...
            <div class="title-button-group">
                <?php echo modal_anchor(get_uri("lds/vehicles/modal_form"), "<i class='fa fa-plus-circle'></i> " . lang('add_vehicle'), array("class" => "btn btn-default", "title" => lang('add_vehicle'))); ?>
            </div>
        </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#vehicle-table").appTable({
            source: '<?php echo_uri("lds/vehicles/list_data") ?>',
            order: [[0, 'desc']],
            columns: [
