<div id="page-content" class="clearfix p20">
    <div class="panel clearfix">
        <ul id="disciplinary-tabs" data-toggle="ajax-tab" class="nav nav-tabs bg-white title" role="tablist">
            ...
            <li><a role="presentation" href="<?php echo_uri("hrs/discipline_entries"); ?>" data-target="#discipline-entries"><?php echo lang('entries'); ?></a></li>
            <li><a role="presentation" href="<?php echo_uri("hrs/discipline_categories"); ?>" data-target="#discipline-categories"><?php echo lang('categories'); ?></a></li>
            <div class="tab-title clearfix no-border">
                <div class="title-button-group">
                    <?php echo modal_anchor(get_uri("hrs/discipline_categories/modal_form"), "<i class='fa fa-plus-circle'></i> " . lang('add_category'), array("class" => "btn btn-default", "title" => lang('add_category'), "id" => "add_category_button")); ?>
                    <?php echo modal_anchor(get_uri("hrs/discipline_entries/modal_form"), "<i class='fa fa-plus-circle'></i> " . lang('add_entry'), array("class" => "btn btn-default", "title" => lang('add_entry'), "id" => "add_entry_button")); ?>
                </div>
            </div>
        </ul>
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#discipline-categories-table").appTable({
            source: '<?php echo_uri("hrs/discipline_categories/list_data") ?>',
            order: [[0, 'desc']],
            columns: [
