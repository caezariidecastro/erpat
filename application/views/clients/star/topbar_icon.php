...
if ($this->login_user->user_type == "staff") {
    ...
    if ($this->login_user->is_admin || $access_client) {
        ?>
        <li class="hidden-xs">
            <?php echo ajax_anchor(get_uri("sales/Clients/show_my_starred_clients/"), "<i class='fa fa-briefcase starred-icon'></i>", array("class" => "dropdown-toggle", "data-toggle" => "dropdown", "data-real-target" => "#clients-quick-list-container")); ?>
