    ...
    <div class="panel panel-default">
        <div class="page-title clearfix">
            ...
            <div class="title-button-group">
                <?php echo modal_anchor(get_uri("mes/Suppliers/modal_form"), "<i class='fa fa-plus-circle'></i> " . lang('add_supplier'), array("class" => "btn btn-default", "title" => lang('add_supplier'), "id" => "add_supplier_button")); ?>
            </div>
        </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#vendors-table").appTable({
            source: '<?php echo_uri("mes/Suppliers/list_data") ?>',
            filterDropdown: [
