    ...
    <div class="panel panel-default">
        <div class="page-title clearfix">
            ...
            <div class="title-button-group">
                <?php echo modal_anchor(get_uri("bill_of_materials/modal_form"), "<i class='fa fa-plus-circle'></i> " . lang('add_bill_of_material'), array("class" => "btn btn-default", "title" => lang('add_bill_of_material'))); ?>
            </div>
        </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#bill-of-materials-table").appTable({
            source: '<?php echo_uri("bill_of_materials/list_data") ?>',
            order: [[0, 'desc']],
            columns: [
