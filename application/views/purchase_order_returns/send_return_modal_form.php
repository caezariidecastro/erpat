<?php echo form_open(get_uri("purchase_order_returns/send_return"), array("id" => "send-return-form", "class" => "general-form", "role" => "form")); ?>
<div id="send_return-dropzone" class="post-dropzone">
    <div class="modal-body clearfix">
        <input type="hidden" name="id" value="<?php echo $purchase_return_info->id; ?>" />
        ...
        <div class="form-group">
            <label for="return_cc" class=" col-md-3">CC</label>
            <div class="col-md-9">
                <?php
        ...
        <div class="form-group">
            <label for="return_bcc" class=" col-md-3">BCC</label>
            <div class="col-md-9">
                <?php
                echo form_input(array(
                    "id" => "return_bcc",
        ...
        <div class="form-group ml15">
            <i class='fa fa-check-circle' style="color: #5CB85C;"></i> <?php echo lang('attached') . ' ' . anchor(get_uri("purchase_order_returns/download_pdf/" . $purchase_return_info->id), lang("return") . "-$purchase_return_info->id.pdf", array("target" => "_blank")); ?> 
        </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        var uploadUrl = "<?php echo get_uri("purchase_order_returns/upload_file"); ?>";
        var validationUri = "<?php echo get_uri("purchase_order_returns/validate_returns_file"); ?>";

        var dropzone = attachDropzoneWithForm("#send_return-dropzone", uploadUrl, validationUri);

        $('#send-purchase-form .select2').select2();
        $("#send-return-form").appForm({
        ...
        $("#contact_id").select2().on("change", function () {
            ...
            if (contact_id) {
                ...
                appLoader.show();
                $.ajax({
                    url: "<?php echo get_uri('purchase_order_returns/get_send_return_template/' . $purchase_return_info->id) ?>" + "/" + contact_id + "/json",
                    dataType: "json",
