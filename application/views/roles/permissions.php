        ...
        $("#permission-table").appTable({
            ...
            columns: [
                ...
                let refresh = function() {
                    $("#leave_specific_dropdown, #attendance_specific_dropdown, #timesheet_manage_permission_specific_dropdown, #team_member_update_permission_specific_dropdown, #message_permission_specific_dropdown, #lead_specific_dropdown, #ticket_staff_specific_dropdown, #staff_specific_dropdown").select2({
                        multiple: true,
                    ...
                    var selectors = ["leave", "attendance", "timesheet", "team_member_update", "ticket", "message_permission", "team_member_update_permission", "timesheet_manage_permission", "lead", "ticket_staff", "staff"];
