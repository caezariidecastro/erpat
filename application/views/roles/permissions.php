        ...
        <div class="panel-body">
            ...
            <ul class="permission-list">
                ...
                <li>
                    ...
                    <strong class="perm-head"><?php echo lang("can_manage_announcements"); ?></strong>
                    <div>
                        <?php
                    ...
                    <strong class="perm-head"><?php echo lang("set_event_permissions"); ?></strong>
                    <div>
                        <?php
                    ...
                    <strong class="perm-head"><?php echo lang("set_message_permissions"); ?></strong>
                    <div>
                        <?php
                ...
                <!-- HRS -->
                <li>
                    <h4><?php echo lang("module_hrs"); ?>:</h4>
                    <div>
                        <?php
                ...
                <!-- MCS -->
                <li>
                    <h4><?php echo lang("module_mcs"); ?>:</h4>
                    <div>
                        <?php
                ...
                <!-- SMS -->
                <li>
                    <h4><?php echo lang("module_sms"); ?>:</h4>
                    <div>
                        <?php
                ...
                <!-- FAS -->
                <li>
                    <h4><?php echo lang("module_fas"); ?>:</h4>
                    <div>
                        <?php
                ...
                <!-- CSS -->
                <li>
                    <h4><?php echo lang("module_css"); ?>:</h4>
                    <div>
                        <?php
                ...
                <!-- PMS -->
                <li>
                    <h4><?php echo lang("module_pms"); ?>:</h4>
                    <div>
                        <?php
                ...
                <!-- ATS -->
                <li>
                    <h4><?php echo lang("module_ats"); ?>:</h4>
                    <div>
                        <?php
                        echo form_checkbox("module_ats", "1", $module_ats ? true : false, "id='module_ats'");
                        ?>
                        <label for="module_ats"><?php echo lang("module_enable"); ?></label>
                    </div>
                </li>
                <!-- LDS -->
                <li>
                    <h4><?php echo lang("module_lds"); ?>:</h4>
                    <div>
                        <?php
                ...
                <!-- MES -->
                <li>
                    <h4><?php echo lang("module_mes"); ?>:</h4>
                    <div>
                        <?php
