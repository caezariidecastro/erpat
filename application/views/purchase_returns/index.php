    ...
    <div class="panel panel-default">
        <div class="page-title clearfix">
            ...
            <div class="title-button-group">
                <?php echo modal_anchor(get_uri("mes/PurchaseReturns/modal_form"), "<i class='fa fa-plus-circle'></i> " . lang('add_return'), array("class" => "btn btn-default", "title" => lang('add_return'))); ?>
            </div>
        </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#purchase-order-returns-table").appTable({
            source: '<?php echo_uri("mes/PurchaseReturns/list_data") ?>',
            filterDropdown: [
