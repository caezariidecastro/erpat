<?php echo form_open(get_uri("asset_brands/save"), array("id" => "brand-form", "class" => "general-form", "role" => "form")); ?>
    ...
    $(document).ready(function () {
        ...
        $("#brand-form").appForm({
            onSuccess: function (result) {
                $("#asset-brand-table").appTable({newData: result.data, dataId: result.id});
            }
        });
    });
</script>