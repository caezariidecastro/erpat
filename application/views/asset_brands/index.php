    ...
    <div class="panel panel-default">
        <div class="page-title clearfix">
            ...
            <div class="title-button-group">
                <?php echo modal_anchor(get_uri("asset_brands/modal_form"), "<i class='fa fa-plus-circle'></i> " . lang('add_brand'), array("class" => "btn btn-default", "title" => lang('add_brand'))); ?>
            </div>
        </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#asset-brand-table").appTable({
            source: "<?php echo_uri("asset_brands/list_data") ?>",
            filterDropdown: [
