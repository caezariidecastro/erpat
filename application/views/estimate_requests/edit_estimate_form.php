<div id="page-content" class="p20 clearfix">
    ...
    <div id="estimate-form-editable" class="panel panel-default  p15 no-border clearfix" style="max-width: 1000px; margin: auto;">
        <div class="clearfix pl10 pr10">
            ...
            <?php echo anchor(get_uri("sales/Estimate_requests/preview_estimate_form/" . $model_info->id), lang('preview'), array("class" => "btn btn-default round mt15 pull-right", "title" => lang('preview'))); ?> 
        </div>
        ...
        <div class="p15">
            <div class='text-center'> <?php echo modal_anchor(get_uri("sales/Estimate_requests/estimate_form_field_modal_form/" . $model_info->id), "<i class='fa fa-plus-circle'></i> " . lang('add_field'), array("class" => "btn btn-default round ", "title" => lang('add_field'))); ?> </div>
        </div>
    </div>
</div>
            ...
            onInitComplete: function () {
                ...
                Sortable.create($selector[0], {
                    ...
                    onUpdate: function (e) {
                        ...
                        //update sort indexes
                        $.ajax({
                            url: '<?php echo_uri("sales/Estimate_requests/update_form_field_sort_values/" . $model_info->id) ?>',
                            type: "POST",
