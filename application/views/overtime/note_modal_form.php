<?php
$url = "hrs/overtime/save_note";

if ($clock_out == "1") {
    $url = "hrs/overtime/log_time/$user_id";
}

echo form_open(get_uri($url), array("id" => "overtime-note-form", "class" => "general-form", "role" => "form"));
?>
