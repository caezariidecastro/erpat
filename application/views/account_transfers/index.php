    ...
    <div class="panel panel-default">
        <div class="page-title clearfix">
            ...
            <div class="title-button-group">
                <?php echo modal_anchor(get_uri("fas/account_transfers/modal_form"), "<i class='fa fa-plus-circle'></i> " . lang('add_account_transfer'), array("class" => "btn btn-default", "title" => lang('add_account_transfer'))); ?>
            </div>
        </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#account-transfers-table").appTable({
            source: '<?php echo_uri("fas/account_transfers/list_data") ?>',
