    ...
    <div class="panel panel-default">
        <div class="page-title clearfix">
            ...
            <div class="title-button-group">
                <?php echo modal_anchor(get_uri("lds/deliveries/modal_form"), "<i class='fa fa-plus-circle'></i> " . lang('add_delivery'), array("class" => "btn btn-default", "title" => lang('add_delivery'))); ?>
            </div>
        </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#deliveries-table").appTable({
            source: '<?php echo_uri("lds/deliveries/list_data") ?>',
            order: [[8, 'desc']],
            columns: [
