...
<div class="page-title clearfix">
    <div class="title-button-group">
        <?php echo modal_anchor(get_uri("leaves/modal_form_add_credit"), "<i class='fa fa-plus-circle'></i> " . lang('add_leave_credits'), array("class" => "btn btn-default", "title" => lang('leave_credit_add_form'))); ?>
        <?php echo modal_anchor(get_uri("leaves/modal_form_deduct_credit"), "<i class='fa fa-minus-circle'></i> " . lang('remove_leave_credits'), array("class" => "btn btn-default", "title" => lang('leave_credit_deduct_form'))); ?>
    </div>
</div>
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#leave-credit-table").appTable({
            source: '<?php echo_uri("leave_credits/list_data") ?>',
