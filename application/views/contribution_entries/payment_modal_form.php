<?php echo form_open(get_uri("contribution_entries/pay/".$model_info->id), array("id" => "contribution-payment-form", "class" => "general-form", "role" => "form")); ?>
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#contribution-payment-form").appForm({
        ...
        $("#contribution-payment-form .select2").select2();
