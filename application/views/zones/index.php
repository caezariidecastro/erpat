...
<script type="text/javascript">
    $(document).ready(function () {
        $("#zone-table").appTable({
            ...
            order: [[0, 'desc']],
            filterDropdown: [
                {name: "labels_select2_filter", class: "w200", options: <?php echo $zones_labels_dropdown; ?>}, {name: "status_select2_filter", class: "w120", options: <?php echo json_encode($status_select2); ?>}, {id: "warehouse_select2_filter", name: "warehouse_select2_filter", class: "w200", options: <?php echo json_encode($warehouse_select2); ?>}
            ],
            columns: [
