<div id="page-content" class="p20 clearfix participants-modal">
    ...
    <div class="page-title clearfix">
        <div class="title-button-group" style="display: flex; margin-bottom: 10px;">
            ...
            <?php echo form_close(); ?>
            <?php echo form_open(get_uri("Raffle_draw/random_join/".$model_info->id), array("id" => "random_join-form", "class" => "general-form", "role" => "form")); ?>
                <button type="submit" class="btn btn-warning"><span class="fa fa-plus "></span>  <?php echo lang('random_join'); ?></button>
            <?php echo form_close(); ?>
