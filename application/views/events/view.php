    ...
    <div class="table-responsive mb15">
        ...
        <?php if ($model_info->company_name && $this->login_user->user_type != "client") { ?>
            <div class="col-md-12 pb10 pt10 ">
                ...
                <?php
                echo $model_info->is_lead ? anchor("mcs/leads/view/" . $model_info->client_id, $model_info->company_name) : anchor("sms/clients/view/" . $model_info->client_id, $model_info->company_name);
                ?>
            </div>
        <?php } ?>
