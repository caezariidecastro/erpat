            ...
            <div role="tabpanel" class="tab-pane fade" id="warehouse-tab">
                <div class="page-title clearfix">
                    <div class="title-button-group">
                        <?php echo modal_anchor(get_uri("inventory/Warehouses/modal_form"), "<i class='fa fa-plus-circle'></i> " . lang('add_warehouse'), array("class" => "btn btn-default", "title" => lang('add_warehouse'))); ?>
                    </div>
                </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#warehouse-table").appTable({
            source: '<?php echo_uri("inventory/Warehouses/list_data") ?>',
            order: [[0, 'desc']],
            columns: [
