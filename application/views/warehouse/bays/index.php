    ...
    <div class="panel panel-default">
        <div class="page-title clearfix">
            ...
            <div class="title-button-group">
                ...
                <?php echo modal_anchor(get_uri("inventory/Bays/modal_form"), "<i class='fa fa-plus-circle'></i> " . lang('add_bay'), array("class" => "btn btn-default", "title" => lang('add_bay'))); ?>
            </div>
        </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#bay-table").appTable({
            source: '<?php echo_uri("inventory/Bays/list_data/".$rack_id) ?>',
            order: [[0, 'desc']],
            filterDropdown: [
