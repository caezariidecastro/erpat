    ...
    <div class="panel panel-default">
        <div class="page-title clearfix">
            ...
            <div class="title-button-group">
                ...
                <?php echo modal_anchor(get_uri("lds/pallets/export_modal_form"), "<i class='fa fa-file'></i> " . lang('export_barcode'), array("class" => "btn btn-default", "title" => lang('export_barcode'))); ?>
