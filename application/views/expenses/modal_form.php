<?php echo form_open(get_uri("fas/expenses/save"), array("id" => "expense-form", "class" => "general-form", "role" => "form")); ?>
<div id="expense-dropzone" class="post-dropzone">
    <div class="modal-body clearfix">
        ...
        <div class="form-group">
            <label for="expense_user_id" class=" col-md-3"><?php echo lang('user'); ?></label>
            <div class="col-md-9">
                <?php
