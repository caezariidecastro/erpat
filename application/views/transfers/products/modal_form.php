...
<?php echo form_open(get_uri("lds/transfers/save"), array("id" => "inventory-transfers-form", "class" => "general-form", "role" => "form")); ?>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $("#inventory-transfers-items-table").appTable({
            source: '<?php echo_uri("lds/transfers/get_transferred_items/".($model_info ? $model_info->reference_number : "")) ?>',
            order: [[0, 'desc']],
            columns: [
                {visible: false},
        ...
        $("#transferee").select2().on("change", function () {
            ...
            if (warehouse_id) {
                ...
                $.ajax({
                    url: "<?php echo get_uri("lds/transfers/get_inventory_items_select2_data") ?>" + `/${warehouse_id}/json`,
                    dataType: "json",
