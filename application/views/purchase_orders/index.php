    ...
    <div class="panel panel-default">
        <div class="page-title clearfix">
            ...
            <div class="title-button-group">
                <?php echo modal_anchor(get_uri("mes/PurchaseOrders/modal_form"), "<i class='fa fa-plus-circle'></i> " . lang('add_purchase'), array("class" => "btn btn-default", "title" => lang('add_purchase'))); ?>
            </div>
        </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#purchase-orders-table").appTable({
            source: '<?php echo_uri("mes/PurchaseOrders/list_data") ?>',
            filterDropdown: [
