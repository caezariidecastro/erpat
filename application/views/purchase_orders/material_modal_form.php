<?php echo form_open(get_uri("purchase_orders/save_material"), array("id" => "purchase-order-material-form", "class" => "general-form", "role" => "form")); ?>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#material").select2().change(function(){
            ...
            if(material_id){
                $.ajax({
                    url: "<?php echo get_uri("material_entries/get_material"); ?>",
                    data: {id: material_id},
                    cache: false,
                    type: 'POST',
                    dataType: "json",
                    success: function (response) {
                        ...
                        $.ajax({
                            url: "<?php echo get_uri("purchase_orders/get_warehouses_select2_data") ?>",
                            data: {
