    ...
    <div class="panel panel-default">
        <div class="page-title clearfix">
            ...
            <div class="title-button-group">
                <?php echo modal_anchor(get_uri("material_inventory_transfers/modal_form"), "<i class='fa fa-plus-circle'></i> " . lang('add_transfer'), array("class" => "btn btn-default", "title" => lang('add_transfer'))); ?>
            </div>
        </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#material-inventory-transfers-table").appTable({
            source: '<?php echo_uri("material_inventory_transfers/list_data") ?>',
            order: [[7, 'desc']],
            columns: [
