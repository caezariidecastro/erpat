<?php echo form_open(get_uri("mcs/leads/save_file"), array("id" => "file-form", "class" => "general-form", "role" => "form")); ?>
<div class="modal-body clearfix">
    <input type="hidden" name="client_id" value="<?php echo $client_id; ?>" />
    <?php
    $this->load->view("includes/multi_file_uploader", array(
        "upload_url" =>get_uri("mcs/leads/upload_file"),
        "validation_url" =>get_uri("mcs/leads/validate_file"),
    ));
    ?>
</div>
