...
class Material_inventory_model extends Crud_model {
    ...
    function get_details($options = array()) {
        ...
        COALESCE((
            SELECT SUM(bill_of_materials_materials.quantity * productions.quantity + ((bill_of_materials_materials.quantity * productions.quantity) * ROUND(productions.buffer / 100, 2)))
