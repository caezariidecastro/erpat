...
class EPass_area_model extends Crud_model {
    ...
    function get_details($options = array()) {
        ...
        (SELECT COUNT(epass_seat.id) FROM epass_seat INNER JOIN epass_block ON epass_block.id = epass_seat.block_id WHERE epass_seat.deleted = '0' AND epass_block.area_id = $epass_area_table.id) as `seats`
