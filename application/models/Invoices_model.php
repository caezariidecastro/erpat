...
class Invoices_model extends Crud_model {
    ...
    function get_details($options = array()) {
        ...
        LEFT JOIN users consumer ON consumer.id = $invoices_table.consumer_id
        $join_custom_fieds
