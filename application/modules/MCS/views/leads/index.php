    ...
    <ul class="nav nav-tabs bg-white title" role="tablist">
        ...
        <div class="tab-title clearfix no-border">
            <div class="title-button-group">
                <?php echo modal_anchor(get_uri("mcs/leads/import_leads_modal_form"), "<i class='fa fa-upload'></i> " . lang('import_leads'), array("class" => "btn btn-default", "title" => lang('import_leads'))); ?>
                <?php echo modal_anchor(get_uri("mcs/leads/modal_form"), "<i class='fa fa-plus-circle'></i> " . lang('add_lead'), array("class" => "btn btn-default", "title" => lang('add_lead'))); ?>
            </div>
        </div>
    </ul>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#lead-table").appTable({
            source: '<?php echo_uri("mcs/leads/list_data") ?>',
            columns: [
