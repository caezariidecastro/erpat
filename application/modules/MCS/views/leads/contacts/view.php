...
<div id="page-content" class="clearfix">
    <div class="row bg-dark-success p20">
        ...
        <div class="col-md-6">
            <p> 
                <?php
                $client_link = anchor(get_uri("mcs/leads/view/" . $lead_info->id), $lead_info->company_name, array("class" => "white-link"));

                if ($this->login_user->user_type === "client") {
                    $client_link = anchor(get_uri("mcs/leads/contact_profile/" . $this->login_user->id . "/company"), $lead_info->company_name, array("class" => "white-link"));
                }
    ...
    <ul data-toggle="ajax-tab" class="nav nav-tabs" role="tablist">
        <li><a  role="presentation" href="<?php echo_uri("mcs/leads/contact_general_info_tab/" . $user_info->id); ?>" data-target="#tab-general-info"> <?php echo lang('general_info'); ?></a></li>
        <li><a  role="presentation" href="<?php echo_uri("mcs/leads/company_info_tab/" . $user_info->client_id); ?>" data-target="#tab-company-info"> <?php echo lang('company'); ?></a></li>
        <li><a  role="presentation" href="<?php echo_uri("mcs/leads/contact_social_links_tab/" . $user_info->id); ?>" data-target="#tab-social-links"> <?php echo lang('social_links'); ?></a></li>
    </ul>
