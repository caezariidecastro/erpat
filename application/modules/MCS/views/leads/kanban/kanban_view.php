<div id="kanban-wrapper">
    ...
    foreach ($leads as $lead) {
        ...
        $make_client = modal_anchor(get_uri("mcs/leads/make_client_modal_form/") . $lead->id, "<i class='fa fa-briefcase'></i>", array("title" => lang('make_client'), "class" => "pull-right mr5 invisible text-off"));
...
<script type="text/javascript">
    ...
    saveStatusAndSort = function ($item, status) {
        ...
        $.ajax({
            url: '<?php echo_uri("mcs/leads/save_lead_sort_and_status") ?>',
            type: "POST",
