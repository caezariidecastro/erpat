<div class="panel">
    <div class="tab-title clearfix">
        ...
        <div class="title-button-group">
            <?php
            echo modal_anchor(get_uri("mcs/leads/file_modal_form"), "<i class='fa fa-plus-circle'></i> " . lang('add_files'), array("class" => "btn btn-default", "title" => lang('add_files'), "data-post-client_id" => $client_id));
            ?>
        </div>
    </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#client-file-table").appTable({
            source: '<?php echo_uri("mcs/leads/files_list_data/" . $client_id) ?>',
            order: [[0, "desc"]],
            columns: [
