<?php echo form_open(get_uri("mcs/leads/save_lead_from_excel_file"), array("id" => "import-lead-form", "class" => "general-form", "role" => "form")); ?>
<div class="modal-body clearfix import-lead-modal-body">
    <div id="upload-area">
        <?php
        $this->load->view("includes/multi_file_uploader", array(
            "upload_url" => get_uri("mcs/leads/upload_excel_file"),
            "validation_url" => get_uri("mcs/leads/validate_import_leads_file"),
            "max_files" => 1,
...
<div class="modal-footer">
    <?php echo anchor("mcs/leads/download_sample_excel_file", "<i class='fa fa-cloud-download'></i> " . lang("download_sample_file"), array("title" => lang("download_sample_file"), "class" => "btn btn-default pull-left")); ?>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $nextButton.click(function () {
            ...
            $.ajax({
                url: "<?php echo get_uri('mcs/leads/validate_import_leads_file_data') ?>",
                type: 'POST',
                dataType: 'json',
