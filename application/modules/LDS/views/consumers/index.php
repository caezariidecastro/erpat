    ...
    <div class="panel panel-default">
        <div class="page-title clearfix">
            ...
            <div class="title-button-group">
                <?php echo modal_anchor(get_uri("lds/consumers/modal_form"), "<i class='fa fa-plus-circle'></i> " . lang('add_consumer'), array("class" => "btn btn-default", "title" => lang('add_consumer'))); ?>
            </div>
        </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#consumer-table").appTable({
            source: '<?php echo_uri("lds/consumers/list_data") ?>',
            order: [[0, 'desc']],
            columns: [
