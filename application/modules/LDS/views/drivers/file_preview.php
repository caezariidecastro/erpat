...
if (isset($file_name) && $file_name) {
    echo "<div class='box saved-file-item-container'><div class='box-content pt5 pb5'>
            ...
            <a href='#' style='position: absolute; right: 15px; background: #ffffff7a;' class='delete-saved-file p5 dark' data-file_name='$file_name'><span class='fa fa-close image-close' style='font-size: 20px;'></span></a>
        </div></div>";
}
?>
