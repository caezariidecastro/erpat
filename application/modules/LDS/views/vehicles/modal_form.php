<?php echo form_open(get_uri("lds/vehicles/save"), array("id" => "vehicle-form", "class" => "general-form", "role" => "form")); ?>
...
<script type="text/javascript">
    $(document).ready(function () {
        let uploadUrl = "<?php echo get_uri("lds/vehicles/upload_file"); ?>";
        let validationUri = "<?php echo get_uri("lds/vehicles/validate_vehicles_file"); ?>";
