    ...
    <div class="panel panel-default">
        <div class="page-title clearfix">
            ...
            <div class="title-button-group">
                <?php echo modal_anchor(get_uri("fas/accounts/modal_form"), "<i class='fa fa-plus-circle'></i> " . lang('add_account'), array("class" => "btn btn-default", "title" => lang('add_account'))); ?>
            </div>
        </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#account-table").appTable({
            source: '<?php echo_uri("fas/accounts/list_data") ?>',
            order: [[0, 'desc']],
            columns: [
