    ...
    <div class="form-group clearfix">
        ...
        <?php if ($expense_info->recurring_expense_id) { ?>
            <div class="col-md-12 mb15">
                ...
                <?php
                echo modal_anchor(get_uri("fas/expenses/expense_details"), lang("original_expense"), array("title" => lang("expense_details"), "data-post-id" => $expense_info->recurring_expense_id));
                ?>
            </div>
        <?php } ?>
...
<div class="modal-footer">
    <?php echo modal_anchor(get_uri("fas/expenses/modal_form"), "<i class='fa fa-pencil'></i> " . lang('edit_expense'), array("class" => "btn btn-default", "data-post-id" => $expense_info->id, "title" => lang('edit_expense'))); ?>
