    ...
    <div class="panel panel-default">
        <div class="page-title clearfix">
            ...
            <div class="title-button-group">
                <?php echo modal_anchor(get_uri("fas/payroll/modal_form"), "<i class='fa fa-plus-circle'></i> " . lang('add_payroll'), array("class" => "btn btn-default", "title" => lang('add_payroll'))); ?>
            </div>
        </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#payroll-table").appTable({
            source: '<?php echo_uri("fas/payroll/list_data") ?>',
            filterDropdown: [
