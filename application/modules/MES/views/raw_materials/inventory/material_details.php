<ul id="material-invetory-tabs" data-toggle="ajax-tab" class="nav nav-tabs bg-white title" role="tablist">
    ...
    <div class="tab-title clearfix no-border">
        <div class="title-button-group">
            <?php echo modal_anchor(get_uri("mes/RawMaterialInventory/add_material_inventory_modal_form"), "<i class='fa fa-plus-circle'></i> " . lang('add_inventory'), array("class" => "btn btn-default", "title" => lang('add_inventory'), "id" => "add_inventory_button")); ?>
        </div>
    </div>
</ul>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#material-inventory-table").appTable({
            source: '<?php echo_uri("mes/RawMaterialInventory/list_data/".$id) ?>',
            columns: [
