<?php echo form_open(get_uri("mes/Suppliers/save_contact"), array("id" => "vendor-contacts-form", "class" => "general-form", "role" => "form")); ?>
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#vendor-contacts-form").appForm({
            onSuccess: function (result) {
                $("#vendor-contacts-table").appTable({newData: result.data, dataId: result.id});
            }
        });
