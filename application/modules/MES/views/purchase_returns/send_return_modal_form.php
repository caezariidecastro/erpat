<?php echo form_open(get_uri("mes/PurchaseReturns/send_return"), array("id" => "send-return-form", "class" => "general-form", "role" => "form")); ?>
<div id="send_return-dropzone" class="post-dropzone">
    <div class="modal-body clearfix">
        ...
        <div class="form-group ml15">
            <i class='fa fa-check-circle' style="color: #5CB85C;"></i> <?php echo lang('attached') . ' ' . anchor(get_uri("mes/PurchaseReturns/download_pdf/" . $purchase_return_info->id), lang("return") . "-$purchase_return_info->id.pdf", array("target" => "_blank")); ?> 
        </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        var uploadUrl = "<?php echo get_uri("mes/PurchaseReturns/upload_file"); ?>";
        var validationUri = "<?php echo get_uri("mes/PurchaseReturns/validate_returns_file"); ?>";
        ...
        $("#contact_id").select2().on("change", function () {
            ...
            if (contact_id) {
                ...
                appLoader.show();
                $.ajax({
                    url: "<?php echo get_uri('mes/PurchaseReturns/get_send_return_template/' . $purchase_return_info->id) ?>" + "/" + contact_id + "/json",
                    dataType: "json",
