<?php echo form_open(get_uri("mes/PurchaseOrders/cancel"), array("id" => "purchase-orders-cancel-form", "class" => "general-form", "role" => "form")); ?>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#purchase-orders-cancel-form").appForm({
