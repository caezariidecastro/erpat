...
<table class="table-responsive" style="width: 100%; color: #444;">            
    ...
    <?php
    foreach ($purchase_order_materials as $material) {
        ?>
    ...
    <tr>
        ...
        <td style="text-align: right; width: 20%; border: 1px solid #fff; background-color: <?php echo $color; ?>; color: #fff;">
            <?php echo number_with_decimal($purchase_order_info->total); ?>
        </td>
    </tr>
</table>
<?php if ($purchase_order_info->remarks) { ?>
    <br />
    <br />
    <div style="border-top: 2px solid #f2f2f2; color:#444; padding:0 0 20px 0;"><br /><?php echo nl2br($purchase_order_info->remarks); ?></div>
