    ...
    <div class="panel panel-default">
        <div class="page-title clearfix">
            ...
            <div class="title-button-group">
                <?php echo modal_anchor(get_uri("lms/drivers/modal_form"), "<i class='fa fa-plus-circle'></i> " . lang('add_driver'), array("class" => "btn btn-default", "title" => lang('add_driver'))); ?>
            </div>
        </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#driver-table").appTable({
            source: '<?php echo_uri("lms/drivers/list_data") ?>',
            order: [[0, 'desc']],
            columns: [
