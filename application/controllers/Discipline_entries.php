...
class Discipline_entries extends MY_Controller {
    ...
    private function _make_row($data) {
        return array(
            ...
            modal_anchor(get_uri("hrs/discipline_entries/modal_form"), "<i class='fa fa-pencil'></i>", array("class" => "edit", "title" => lang('edit_entry'), "data-post-id" => $data->id))
            . js_anchor("<i class='fa fa-times fa-fw'></i>", array('title' => lang('delete_entry'), "class" => "delete", "data-id" => $data->id, "data-action-url" => get_uri("hrs/discipline_entries/delete"), "data-action" => "delete-confirmation"))
        );
    }
    ...
    function delete() {
        ...
        if ($this->Discipline_entries_model->delete($id)) {
