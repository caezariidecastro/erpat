...
class Vendors extends MY_Controller {
    ...
    private function _make_contact_row($data) {
        return array(
            ...
            modal_anchor(get_uri("vendors/add_contact_modal_form"), "<i class='fa fa-pencil'></i>", array("class" => "edit", "title" => lang('edit_contact'), "data-post-id" => $data->id, "data-post-vendor_id" => $data->vendor_id))
            . js_anchor("<i class='fa fa-times fa-fw'></i>", array('title' => lang('delete'), "class" => "delete", "data-id" => $data->id, "data-action-url" => get_uri("vendors/delete"), "data-action" => "delete-confirmation"))
        );
    }
    ...
    function contacts($id){
        ...
        $this->template->rander("vendors/contact_list", $view_data);
    }
    ...
    function add_contact_modal_form(){
        ...
        $this->load->view('vendors/add_contact_modal_form', $view_data);
    }
