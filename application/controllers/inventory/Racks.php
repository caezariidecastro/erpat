...
class Racks extends MY_Controller {
    ...
    function index($warehouse_id = 0){
        ...
        $this->load->view("warehouse/racks/index", $view_data);
    }
    ...
    private function _make_row($data) {
        ...
        return array(
            ...
            modal_anchor(get_uri("inventory/Racks/modal_form"), "<i class='fa fa-pencil'></i>", array("class" => "edit", "title" => lang('edit_rack'), "data-post-id" => $data->id))
            . js_anchor("<i class='fa fa-times fa-fw'></i>", array('title' => lang('delete'), "class" => "delete", "data-id" => $data->id, "data-action-url" => get_uri("inventory/Racks/delete"), "data-action" => "delete-confirmation"))
    ...
    function modal_form() {
        ...
        $this->load->view('warehouse/racks/modal_form', $view_data);
    }
