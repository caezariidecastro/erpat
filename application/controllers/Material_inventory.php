                        ...
                        <div class="row">
                            ...
                            <div class="col-md-5">
                                <div class="text-off pull-right text-right">
                                    Stocks on hand: '.($data->stocks + $data->stocks_override - $data->production_quantity + $data->purchased - $data->returned).'
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        $detail = '<div class="pull-left material-row" data-id="'.$data->id.'">
                    <div class="media-body">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="text-off pull-right text-right">
                                    Available stocks: '.($data->stock + $data->stock_override - $data->production_quantity + $data->purchased - $data->returned).'
                                </div>
                            </div>
                        </div>
                    </div>
