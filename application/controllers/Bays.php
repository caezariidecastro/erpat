...
class Bays extends MY_Controller {
    ...
    private function _make_row($data) {
        ...
        return array(
            ...
            . js_anchor("<i class='fa fa-times fa-fw'></i>", array('title' => lang('delete'), "class" => "delete", "data-id" => $data->id, "data-action-url" => get_uri("lds/bays/delete"), "data-action" => "delete-confirmation"))
        );
    }
    ...
    function modal_form() {
        ...
        $this->load->view('bays/modal_form', $view_data);
    }
