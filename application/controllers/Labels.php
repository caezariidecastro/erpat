...
class Labels extends MY_Controller {
    ...
    private function can_access_labels_of_this_context($context = "", $label_id = 0) {
        ...
        if ($context == "project" && $this->can_edit_projects()) {
            ...
            return true;
        } else if ($context == "event" || $context == "note" || $context == "to_do" || $context == "zones" || $context == "racks" || $context == "bays" || $context == "levels" || $context == "positions" || $context == "pallets" || $context == "users") {
            if ($label_id) {
