...
class ProductInventory extends MY_Controller {
    ...
    function add_inventory_modal_form() {
        ...
        $this->load->view('products/inventory/add_inventory', $view_data);
    }
    ...
    function add_stock_modal_form($warehouse_id, $inventory_id) {
        ...
        $this->load->view('products/inventory/add_stock', $view_data);
    }
    ...
    function item_details($id){
        $data = $this->load->view('products/inventory/item_details', array('id'=> $id));
