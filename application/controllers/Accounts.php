...
class Accounts extends MY_Controller {
    ...
    private function _make_row($data) {
        return array(
            ...
            modal_anchor(get_uri("fas/accounts/modal_form"), "<i class='fa fa-pencil'></i>", array("class" => "edit", "title" => lang('edit_account'), "data-post-id" => $data->id))
            . js_anchor("<i class='fa fa-times fa-fw'></i>", array('title' => lang('delete'), "class" => "delete", "data-id" => $data->id, "data-action-url" => get_uri("fas/accounts/delete"), "data-action" => "delete-confirmation"))
        );
    }
