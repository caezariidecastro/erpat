...
class Settings extends MY_Controller {
    ...
    function save_general_settings() {
        $settings = array("site_logo", "favicon", "show_background_image_in_signin_page", "show_logo_in_signin_page", "site_title", "site_admin_email", "language", "enable_training",);
    ...
    function save_calendar_settings() {
        $settings = array("timezone", "date_format", "time_format", "first_day_of_week", "weekends", "breaktime_tracking", "whitelisted_breaktime_tracking", "auto_clockout", "whitelisted_autoclockout", "auto_clockin_employee", "overtime_trigger", "bonuspay_trigger", "nightpay_start_trigger", "nightpay_end_trigger");
