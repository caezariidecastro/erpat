...
class Settings extends MY_Controller {
    ...
    function save_calendar_settings() {
        $settings = array("timezone", "date_format", "time_format", "first_day_of_week", "weekends", "breaktime_tracking", "whitelisted_breaktime_tracking", "auto_clockout", "whitelisted_autoclockout", "whitelisted", "overtime_trigger", "bonuspay_trigger", "nightpay_start_trigger", "nightpay_end_trigger");
