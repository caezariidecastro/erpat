...
class Leave_credits extends MY_Controller {
    ...
    private function _make_row($data) {
        ...
        return array(
            ...
            js_anchor("<i class='fa fa-times fa-fw'></i>", array('title' => lang('delete_leave_type'), "class" => "delete", "data-id" => $data->id, "data-action-url" => get_uri("leave_credits/delete"), "data-action" => "delete"))
        );
    }
