...
class Migration_Alter_payslips_drop_columns extends CI_Migration { 
        ...
        public function up()
        {
                ...
                $fields = array(
                        "`bonus` decimal(10,2) DEFAULT 0 after absent",
                        "`leave_credit` decimal(10,2) DEFAULT 0 after bonus",
                        "`special_hd` decimal(10,2) DEFAULT 0 after leave_credit",
                        "`legal_hd` decimal(10,2) DEFAULT 0 after special_hd",
